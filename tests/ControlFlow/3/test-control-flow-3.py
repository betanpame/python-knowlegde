...
# Starter code for Control Flow Test 3
...
def run_conditional_tests():
    ...
    print("=== Basic If-Else Statement Tests ===")
    ...
    print("Clothing Suggestion Tests:")
    ...
    print("Grade Determination Tests:")
    ...
    print("Discount Calculation Tests:")
