# Encapsulation and Access Control - Test 14
...
def create_encapsulated_class():
    ...
    # Test protected access (works but discouraged)
    ...
    # Test private access (fails with name mangling)
...
def test_validation_and_methods(alice_account, bob_account):
    """Test validation and method access control."""
...
def test_admin_functions(alice_account):
    """Test admin functions and frozen account behavior."""
