...
# Starter code for NumPy Practice 1
...
if __name__ == "__main__":
    ...
    # Practice percentage calculator
    print("\n=== Percentage Calculator ===")
    try:
        # Practice data: student scores
    ...
    # Practice data analysis pipeline
