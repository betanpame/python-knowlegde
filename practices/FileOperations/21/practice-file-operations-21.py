...
# Starter code for File Operations Practice 21
...
if __name__ == "__main__":
    ...
    try:
        safe_results = safe_file_operations("test_safe.txt", "Practice content for safe operations")
