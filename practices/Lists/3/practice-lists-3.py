...
# Starter code for Lists Practice 3
...
def run_basic_list_tests():
    ...
    print("=== Basic List Operations Practices ===")
    
    # Practice with different types of lists
    test_lists = [
        [1, 2, 3, 4, 5],           # numbers
    ...
    for i, test_list in enumerate(test_lists):
        print(f"Practice List {i+1}: {test_list}")
    ...
    # Practice element access
    numbers = [10, 20, 30, 40, 50]
    print("Element Access Practices:")
