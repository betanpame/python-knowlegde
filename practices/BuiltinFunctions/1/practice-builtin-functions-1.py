...
# Starter code for Built-in Functions Practice 1
...
The Purpose Is To Practice File Reading Capabilities.
...
if __name__ == "__main__":
    ...
    # Practice generator vs list comparison
