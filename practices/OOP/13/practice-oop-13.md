# Abstract Base Classes and Interfaces - Practice 13
...
def test_alternative_constructors():
    """Practice abstract class methods for alternative constructors."""
...
def test_type_checking():
    """Practice isinstance and issubclass with abstract base classes."""
    print(f"\n=== Type Checking Demo ===")
...
if __name__ == "__main__":
    # Practice abstract base class creation
    shapes = create_abstract_base_class()
    
    # Practice polymorphism
    demonstrate_polymorphism(shapes)
    
    # Practice alternative constructors
