# Multiple Inheritance and Method Resolution Order - Practice 12
...
def create_multiple_inheritance():
    ...
    # Practice movement (overridden in each class)
    print(f"\n=== Movement Practices ===")
    for animal in animals:
        print(f"  {animal.move()}")
    
    # Practice specific abilities
    print(f"\n=== Specific Abilities ===")
