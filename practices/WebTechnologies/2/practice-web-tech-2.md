# HTTP Requests and API Integration - Practice 2
...
def api_error_handling():
    ...
    test_urls = [
        ...
        ('https://httpbin.org/delay/10', 'Timeout Practice')  # Will timeout
    ]
...
def build_api_client():
    ...
    try:
        ...
        new_post = client.create_post(
            title="Practice Post from API Client",
